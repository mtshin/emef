...
export default function EASAboutSection() {
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <h5 className={classes.description}>
            ...
            observing works through multiple perspectives and approaching
            subjects/mediums based on artistic fundamentals. Positive thinking,
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={8}>
            <Card>
              ...
              <CardBody>
                <p>
                  You can be an Artist. EAS teaches with the love of Jesus to
