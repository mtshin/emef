            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={8}>
                ...
                <h4 className={classes.description}>
                  ...
                  inquiries with your resume/CV to <a href="mailto:emef@teachers.org">emef900@gmail.com</a> or{" "}
                  <a href="mailto:emef@teachers.org">emef@teachers.org</a>. We look forward to hearing from you!
                </h4>
              </GridItem>
            </GridContainer>
          </div>
